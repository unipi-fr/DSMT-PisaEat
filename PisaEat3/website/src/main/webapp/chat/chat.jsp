...
<div class="input-group">
    ...
    <input id="messageBody" type="text" name="messageBody" placeholder="Type a message for the kitchen"
           aria-describedby="send-message" class="form-control rounded-0 border-0 py-4 bg-light">
